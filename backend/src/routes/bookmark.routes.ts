...
import { list, getOne, create, update, remove, toggleFavorite, refreshMetadata } from '@/controllers/bookmark.controller';
...
router.patch('/:id/refresh-metadata', refreshMetadata);
