...
//#endregion
//#region ../frontend/src/utils/cn.ts
...
var Popup_module_default = {
	popup: "_popup_1awug_2",
	header: "_header_1awug_16",
	headerLeft: "_headerLeft_1awug_26",
	headerIcon: "_headerIcon_1awug_32",
	headerTitle: "_headerTitle_1awug_37",
	headerActions: "_headerActions_1awug_44",
	iconBtn: "_iconBtn_1awug_50",
	body: "_body_1awug_69",
	preview: "_preview_1awug_79",
	previewImage: "_previewImage_1awug_90",
	previewPlaceholder: "_previewPlaceholder_1awug_96",
	previewOverlay: "_previewOverlay_1awug_108",
	pageIdentity: "_pageIdentity_1awug_115",
	favicon: "_favicon_1awug_121",
	faviconImg: "_faviconImg_1awug_134",
	faviconFallback: "_faviconFallback_1awug_140",
	pageNameWrapper: "_pageNameWrapper_1awug_145",
	pageNameLabel: "_pageNameLabel_1awug_150",
	pageNameInput: "_pageNameInput_1awug_160",
	orgRow: "_orgRow_1awug_184",
	fieldGroup: "_fieldGroup_1awug_190",
	fieldLabel: "_fieldLabel_1awug_196",
	fieldInputWrapper: "_fieldInputWrapper_1awug_204",
	fieldIcon: "_fieldIcon_1awug_208",
	fieldInput: "_fieldInput_1awug_204",
	fieldSelect: "_fieldSelect_1awug_235",
	selectArrow: "_selectArrow_1awug_254",
	tagsRow: "_tagsRow_1awug_265",
	tagChip: "_tagChip_1awug_272",
	tagChipIcon: "_tagChipIcon_1awug_286",
	addTagBtn: "_addTagBtn_1awug_290",
	centerState: "_centerState_1awug_312",
	stateIcon: "_stateIcon_1awug_323",
	stateTitle: "_stateTitle_1awug_329",
	stateSub: "_stateSub_1awug_335",
	loginForm: "_loginForm_1awug_342",
	loginInput: "_loginInput_1awug_349",
	loginError: "_loginError_1awug_370",
	footer: "_footer_1awug_377",
	btnSave: "_btnSave_1awug_387",
	btnRemove: "_btnRemove_1awug_419",
	toast: "_toast_1awug_453",
	toastIn: "_toastIn_1awug_1",
	toastSuccess: "_toastSuccess_1awug_473",
	toastIcon: "_toastIcon_1awug_473",
	toastError: "_toastError_1awug_474",
	spinner: "_spinner_1awug_488",
	spin: "_spin_1awug_488"
};
//#endregion
...
var flattenFolders = (folders, depth = 0) => folders.flatMap((f) => [{
	id: f.id,
	name: f.name,
	depth
...
var Popup = () => {
	...
	const [tabInfo, setTabInfo] = (0, import_react.useState)({
		url: "",
		title: "",
		favIconUrl: ""
	});
	...
	const [tags, setTags] = (0, import_react.useState)(["Diseño", "Recursos"]);
	...
	(0, import_react.useEffect)(() => {
		const init = async () => {
			...
			chrome.tabs.query({
				...
				if (!tabId) return;
				chrome.tabs.sendMessage(tabId, { type: "GET_METADATA" }, (meta) => {
			...
			try {
				setFolders((await extApi.getFolders()).folders);
			} catch {}
			setView("main");
		};
		init();
	...
	const handleLogin = async () => {
		...
		try {
			...
			setLoginError(error instanceof ExtApiError ? error.message : "Error al iniciar sesión");
		} finally {
	...
	const handleSave = async () => {
		...
		try {
			await extApi.createBookmark({
				...
				tagNames: tags.length > 0 ? tags : void 0
			});
			chrome.runtime.sendMessage({ type: "BOOKMARK_SAVED" });
			showToast("Marcador guardado en tu archivo", "success");
			setTimeout(() => window.close(), 1500);
		} catch (error) {
			showToast(error instanceof ExtApiError ? error.message : "Error al guardar", "error");
		} finally {
			setIsSaving(false);
		}
	};
	...
	flatFolders.find((f) => f.id === folderId);
	if (view === "loading") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: Popup_module_default.popup,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: Popup_module_default.header,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: Popup_module_default.headerLeft,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: cn("material-symbols-outlined", Popup_module_default.headerIcon),
					children: "bookmark"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: Popup_module_default.headerTitle,
					children: "Bookmark Manager"
				})]
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: Popup_module_default.centerState,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: Popup_module_default.spinner }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: Popup_module_default.stateSub,
				children: "Cargando..."
			})]
		})]
	});
	if (view === "login") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: Popup_module_default.popup,
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: Popup_module_default.body,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: Popup_module_default.centerState,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: cn("material-symbols-outlined", Popup_module_default.stateIcon),
							children: "lock"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: Popup_module_default.stateTitle,
							children: "Ingresá a tu cuenta"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: Popup_module_default.stateSub,
							children: "Necesitás iniciar sesión para guardar marcadores."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: Popup_module_default.loginForm,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									className: Popup_module_default.loginInput,
									type: "email",
								...
								loginError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: Popup_module_default.loginError,
									children: loginError
								})
							]
						})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: Popup_module_default.footer,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					className: Popup_module_default.btnSave,
					onClick: handleLogin,
					disabled: isLoggingIn,
					style: { gridColumn: "1 / -1" },
					children: [isLoggingIn ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: Popup_module_default.spinner }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: Popup_module_default.headerActions,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: Popup_module_default.iconBtn,
						title: "Configuración",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: Popup_module_default.preview,
						children: [metadata.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							className: Popup_module_default.previewImage,
							src: metadata.image,
							alt: "Vista previa"
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: Popup_module_default.previewPlaceholder,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "material-symbols-outlined",
								style: { fontSize: 32 },
								children: "language"
						...
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: Popup_module_default.previewOverlay })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: Popup_module_default.pageIdentity,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: Popup_module_default.favicon,
							children: tabInfo.favIconUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								className: Popup_module_default.faviconImg,
								...
								className: cn("material-symbols-outlined", Popup_module_default.faviconFallback),
								children: "language"
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: Popup_module_default.pageNameWrapper,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: Popup_module_default.pageNameLabel,
								children: "Nombre de la página"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								className: Popup_module_default.pageNameInput,
								type: "text",
								value: title,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: Popup_module_default.orgRow,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: Popup_module_default.fieldGroup,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: Popup_module_default.fieldLabel,
								children: "Carpeta"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: Popup_module_default.fieldInputWrapper,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: cn("material-symbols-outlined", Popup_module_default.fieldIcon),
									children: "folder"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									className: Popup_module_default.fieldInput,
									type: "text",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: Popup_module_default.fieldLabel,
								children: "Carpeta existente"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: Popup_module_default.fieldInputWrapper,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
									className: Popup_module_default.fieldSelect,
									value: folderId,
									onChange: (e) => setFolderId(e.target.value),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
										value: "",
										children: "Sin carpeta"
									}), flatFolders.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
										value: f.id,
										children: [
											"  ".repeat(f.depth),
											f.depth > 0 ? "↳ " : "",
									...
									className: cn("material-symbols-outlined", Popup_module_default.selectArrow),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: Popup_module_default.tagsRow,
						children: [tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: Popup_module_default.tagChip,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: cn("material-symbols-outlined", Popup_module_default.tagChipIcon),
									children: "sell"
								}),
								tag,
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: Popup_module_default.addTagBtn,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [isSaving ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: Popup_module_default.spinner }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "material-symbols-outlined",
						style: { fontSize: 20 },
						children: "add_circle"
					}), "AGREGAR"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					className: Popup_module_default.btnRemove,
					onClick: handleRemove,
					disabled: isSaving || isRemoving,
					children: [isRemoving ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: Popup_module_default.spinner }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "material-symbols-outlined",
						style: { fontSize: 20 },
			...
			toast && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn(Popup_module_default.toast, toast.type === "success" ? Popup_module_default.toastSuccess : Popup_module_default.toastError),
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: cn("material-symbols-outlined", Popup_module_default.toastIcon),
					style: { fontSize: 18 },
					children: toast.type === "success" ? "check_circle" : "error"
				}), toast.message]
			})
		]
	});
...
(0, import_client.createRoot)(root).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Popup, {}) }));
//#endregion
